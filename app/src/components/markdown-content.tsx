...
const components: Components = {
  ...
  blockquote: ({ children }) => (
    <blockquote className="mb-3 border-l-2 border-neutral-300 pl-4 text-foreground/60 italic">
      {children}
    </blockquote>
  ),
  code: ({ children, className }) => {
    ...
    return (
      <code className="rounded-md bg-white/[0.06] px-1.5 py-0.5 text-xs font-mono text-neutral-600">
        {children}
      </code>
    );
  },
